...
<head>
  ...
  <link rel="stylesheet" href="exit/style.css">
</head>
<body>
...
<section id="page-structure" class="ajax">
	    <nav class="padded">
	    	<img src="https://la-division-france.eu/articles/image/logo.png" id="nclud-logo">
	    </nav>
	    <div class="header-text grid_row padded-horizontal">
	      <h2 class="grid2">Vous avez tenté d'acceder à du contenu hautement sécurisé, qui que vous soyez rebroussez chemin immédiatement !</h2>
	      <h1 class="grid3">Vous n'êtes pas activés.</h1>
	    </div>
</section>
</div>
